...
class BackendTester:
    ...
    def test_static_file_retrieval(self):
        ...
        try:
            ...
            file_url = f"https://loopsuite.preview.emergentagent.com/api{self.uploaded_file_url}"
    ...
    def run_all_tests(self):
        ...
        # PRIORITY 1: VibeRoom Creation Testing (USER REQUESTED)
        print("\n🎯 PRIORITY 1: VIBEROOM CREATION TESTING (USER REQUESTED)")
        print("-" * 60)
        self.test_viberoom_creation_demo_user()
        self.test_viberoom_creation_existing_user()
        self.test_viberoom_creation_nonexistent_user()
        self.test_get_room_details()
        
        # PRIORITY 2: Agora Token Generation Testing (USER REQUESTED)
        print("\n🎯 PRIORITY 2: AGORA TOKEN GENERATION TESTING (USER REQUESTED)")
        print("-" * 60)
        self.test_agora_token_publisher()
        self.test_agora_token_subscriber()
        
        # PRIORITY 3: Microphone/Audio Functionality Testing (USER REQUESTED)
        print("\n🎯 PRIORITY 3: MICROPHONE/AUDIO FUNCTIONALITY TESTING (USER REQUESTED)")
        print("-" * 60)
        self.test_join_room_as_audience()
        self.test_raise_hand_functionality()
        self.test_invite_to_stage()
        self.test_speaker_token_generation()

        # Priority 4: Authentication Flow (CRITICAL)
        print("\n🔐 PRIORITY 4: AUTHENTICATION FLOW (CRITICAL)")
        print("-" * 60)
