...
async def seed_data():
    ...
    # Seed venues - Hyderabad Based
    venues = [
        # Famous Cafes in Hyderabad
        {"id": "v1", "name": "Concu Bakery & Café", "type": "cafe", "description": "European bakery with artisanal breads and pastries", "avatar": "https://images.unsplash.com/photo-1554118811-1e0d58224f24?w=400", "location": "Jubilee Hills, Hyderabad", "rating": 4.7, "menuItems": [{"id": "m1", "name": "Croissant", "price": 120}, {"id": "m2", "name": "Cappuccino", "price": 180}, {"id": "m3", "name": "Chocolate Tart", "price": 250}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v2", "name": "Marry Brown", "type": "cafe", "description": "Iconic Irani café since 1955, famous for Osmania biscuits", "avatar": "https://images.unsplash.com/photo-1511920170033-f8396924c348?w=400", "location": "Secunderabad, Hyderabad", "rating": 4.5, "menuItems": [{"id": "m4", "name": "Irani Chai", "price": 40}, {"id": "m5", "name": "Osmania Biscuit", "price": 30}, {"id": "m6", "name": "Keema Samosa", "price": 60}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v3", "name": "Roastery Coffee House", "type": "cafe", "description": "Specialty coffee roastery with pour-over and cold brews", "avatar": "https://images.unsplash.com/photo-1501339847302-ac426a4a7cbb?w=400", "location": "Banjara Hills, Hyderabad", "rating": 4.8, "menuItems": [{"id": "m7", "name": "V60 Pour Over", "price": 280}, {"id": "m8", "name": "Flat White", "price": 220}, {"id": "m9", "name": "Cold Brew", "price": 250}], "createdAt": datetime.now(timezone.utc).isoformat()},
        
        # Famous Restaurants
        {"id": "v4", "name": "Paradise Biryani", "type": "restaurant", "description": "Legendary Hyderabadi biryani since 1953", "avatar": "https://images.unsplash.com/photo-1563379091339-03b21ab4a4f8?w=400", "location": "Secunderabad, Hyderabad", "rating": 4.6, "menuItems": [{"id": "m10", "name": "Chicken Biryani", "price": 380}, {"id": "m11", "name": "Mutton Biryani", "price": 450}, {"id": "m12", "name": "Veg Biryani", "price": 320}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v5", "name": "Bawarchi Restaurant", "type": "restaurant", "description": "Famous for authentic Hyderabadi cuisine", "avatar": "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400", "location": "RTC Cross Roads, Hyderabad", "rating": 4.5, "menuItems": [{"id": "m13", "name": "Hyderabadi Biryani", "price": 350}, {"id": "m14", "name": "Haleem", "price": 280}, {"id": "m15", "name": "Double Ka Meetha", "price": 120}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v6", "name": "Ohri's Gufaa", "type": "restaurant", "description": "Cave-themed restaurant with multi-cuisine", "avatar": "https://images.unsplash.com/photo-1552566626-52f8b828add9?w=400", "location": "Road No 1, Banjara Hills", "rating": 4.4, "menuItems": [{"id": "m16", "name": "Paneer Tikka", "price": 320}, {"id": "m17", "name": "Butter Chicken", "price": 420}, {"id": "m18", "name": "Dal Makhani", "price": 280}], "createdAt": datetime.now(timezone.utc).isoformat()},
        
        # Famous Temples
        {"id": "v7", "name": "Birla Mandir", "type": "temple", "description": "Iconic white marble temple overlooking Hussain Sagar Lake", "avatar": "https://images.unsplash.com/photo-1582662093075-4fa0224dbfe9?w=400", "location": "Naubat Pahad, Hyderabad", "rating": 4.9, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v8", "name": "Chilkur Balaji Temple", "type": "temple", "description": "Ancient Visa Balaji temple on Osman Sagar outskirts", "avatar": "https://images.unsplash.com/photo-1564507592333-c60657eea523?w=400", "location": "Moinabad, Hyderabad", "rating": 4.8, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v9", "name": "Jagannath Temple", "type": "temple", "description": "Modern temple dedicated to Lord Jagannath", "avatar": "https://images.unsplash.com/photo-1567157577867-05ccb1388e66?w=400", "location": "Banjara Hills, Hyderabad", "rating": 4.7, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v10", "name": "Keesaragutta Temple", "type": "temple", "description": "Ancient hilltop Shiva temple with panoramic views", "avatar": "https://images.unsplash.com/photo-1548013146-72479768bada?w=400", "location": "Keesara, Hyderabad", "rating": 4.6, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v11", "name": "Sanghi Temple", "type": "temple", "description": "Magnificent temple complex with South Indian architecture", "avatar": "https://images.unsplash.com/photo-1588616434123-e5e9f012f98f?w=400", "location": "Sanghi Nagar, Hyderabad", "rating": 4.7, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        
        # Pubs & Bars
        {"id": "v12", "name": "The 10 Downing Street", "type": "pub", "description": "British-themed pub with live music and craft beers", "avatar": "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=400", "location": "Road No 10, Banjara Hills", "rating": 4.6, "menuItems": [{"id": "m19", "name": "Craft Beer", "price": 350}, {"id": "m20", "name": "Fish & Chips", "price": 520}, {"id": "m21", "name": "Mojito", "price": 380}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v13", "name": "Bottles & Chimney", "type": "pub", "description": "Rooftop bar with city views and cocktails", "avatar": "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400", "location": "Jubilee Hills, Hyderabad", "rating": 4.5, "menuItems": [{"id": "m22", "name": "Signature Cocktail", "price": 450}, {"id": "m23", "name": "Grilled Chicken", "price": 480}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v14", "name": "Over The Moon", "type": "pub", "description": "Terrace lounge with DJ nights and global cuisine", "avatar": "https://images.unsplash.com/photo-1566417713940-fe7c737a9ef2?w=400", "location": "Gachibowli, Hyderabad", "rating": 4.7, "menuItems": [{"id": "m24", "name": "LIIT", "price": 420}, {"id": "m25", "name": "Nachos Platter", "price": 380}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v15", "name": "Aqua - The Park", "type": "pub", "description": "Poolside bar at The Park Hotel", "avatar": "https://images.unsplash.com/photo-1470337458703-46ad1756a187?w=400", "location": "Somajiguda, Hyderabad", "rating": 4.8, "menuItems": [{"id": "m26", "name": "Pool Party Drinks", "price": 500}, {"id": "m27", "name": "Appetizer Platter", "price": 650}], "createdAt": datetime.now(timezone.utc).isoformat()},
        
        # Shopping & Entertainment
        {"id": "v16", "name": "Inorbit Mall", "type": "mall", "description": "Premier shopping destination with top brands", "avatar": "https://images.unsplash.com/photo-1519567241046-7f570eee3ce6?w=400", "location": "HITEC City, Hyderabad", "rating": 4.5, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v17", "name": "GVK One Mall", "type": "mall", "description": "Luxury shopping mall in Banjara Hills", "avatar": "https://images.unsplash.com/photo-1555529669-e69e7aa0ba9a?w=400", "location": "Banjara Hills, Hyderabad", "rating": 4.4, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v18", "name": "Prasads IMAX", "type": "entertainment", "description": "One of the world's largest IMAX screens", "avatar": "https://images.unsplash.com/photo-1489599849927-2ee91cede3ba?w=400", "location": "Necklace Road, Hyderabad", "rating": 4.6, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
    ]
    await db.venues.insert_many(venues)
    
    # Seed events - Hyderabad Based
    events = [
        ...
        {"id": "e2", "name": "Deccan Food Festival", "description": "Taste authentic Hyderabadi cuisine and street food", "image": "https://images.unsplash.com/photo-1555939594-58d7cb561ad1?w=800", "date": "2025-11-28", "location": "Necklace Road, Hyderabad", "tiers": [{"name": "Entry", "price": 400}], "vibeMeter": 89, "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "e3", "name": "Sunburn Arena Hyderabad", "description": "EDM festival featuring international DJs", "image": "https://images.unsplash.com/photo-1470229722913-7c0e2dbbafd3?w=800", "date": "2025-12-15", "location": "GMR Arena, Hyderabad", "tiers": [{"name": "GA", "price": 2999}, {"name": "VIP", "price": 6999}], "vibeMeter": 96, "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "e4", "name": "T-Hub Innovation Summit", "description": "Startup ecosystem event with founders and investors", "image": "https://images.unsplash.com/photo-1540575467063-178a50c2df87?w=800", "date": "2025-11-10", "location": "T-Hub Phase 2, Hyderabad", "tiers": [{"name": "Startup Pass", "price": 1500}, {"name": "Investor Pass", "price": 5000}], "vibeMeter": 91, "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "e5", "name": "Bonalu Festival 2025", "description": "Traditional Telangana festival celebrating Goddess Mahakali", "image": "https://images.unsplash.com/photo-1528696892704-5e1122852276?w=800", "date": "2025-07-20", "location": "Golconda Fort, Hyderabad", "tiers": [{"name": "Free Entry", "price": 0}], "vibeMeter": 92, "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "e6", "name": "Hyderabad Literary Festival", "description": "Books, authors, and poetry readings", "image": "https://images.unsplash.com/photo-1507842217343-583bb7270b66?w=800", "date": "2025-12-05", "location": "Lamakaan, Hyderabad", "tiers": [{"name": "General", "price": 500}], "vibeMeter": 85, "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "e7", "name": "NH7 Weekender Hyderabad", "description": "Multi-genre music festival with indie artists", "image": "https://images.unsplash.com/photo-1501281668745-f7f57925c3b4?w=800", "date": "2025-11-30", "location": "Gachibowli Stadium, Hyderabad", "tiers": [{"name": "Day Pass", "price": 1999}, {"name": "Weekend Pass", "price": 3499}], "vibeMeter": 93, "createdAt": datetime.now(timezone.utc).isoformat()},
    ]
