...
async def seed_data():
    ...
    venues = [
        ...
        {"id": "v1", "name": "Concu Bakery & Café", "type": "cafe", "description": "European bakery with artisanal breads and pastries", "avatar": "https://images.unsplash.com/photo-1517433670267-08bbd4be890f?w=400", "location": "Jubilee Hills, Hyderabad", "rating": 4.7, "menuItems": [{"id": "m1", "name": "Croissant", "price": 120}, {"id": "m2", "name": "Cappuccino", "price": 180}, {"id": "m3", "name": "Chocolate Tart", "price": 250}], "createdAt": datetime.now(timezone.utc).isoformat()},
        ...
        {"id": "v3", "name": "Roastery Coffee House", "type": "cafe", "description": "Specialty coffee roastery with pour-over and cold brews", "avatar": "https://images.unsplash.com/photo-1442512595331-e89e73853f31?w=400", "location": "Banjara Hills, Hyderabad", "rating": 4.8, "menuItems": [{"id": "m7", "name": "V60 Pour Over", "price": 280}, {"id": "m8", "name": "Flat White", "price": 220}, {"id": "m9", "name": "Cold Brew", "price": 250}], "createdAt": datetime.now(timezone.utc).isoformat()},
        ...
        {"id": "v5", "name": "Bawarchi Restaurant", "type": "restaurant", "description": "Famous for authentic Hyderabadi cuisine", "avatar": "https://images.unsplash.com/photo-1585937421612-70a008356fbe?w=400", "location": "RTC Cross Roads, Hyderabad", "rating": 4.5, "menuItems": [{"id": "m13", "name": "Hyderabadi Biryani", "price": 350}, {"id": "m14", "name": "Haleem", "price": 280}, {"id": "m15", "name": "Double Ka Meetha", "price": 120}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v6", "name": "Ohri's Gufaa", "type": "restaurant", "description": "Cave-themed restaurant with multi-cuisine", "avatar": "https://images.unsplash.com/photo-1517248135467-4c7edcad34c4?w=400", "location": "Road No 1, Banjara Hills", "rating": 4.4, "menuItems": [{"id": "m16", "name": "Paneer Tikka", "price": 320}, {"id": "m17", "name": "Butter Chicken", "price": 420}, {"id": "m18", "name": "Dal Makhani", "price": 280}], "createdAt": datetime.now(timezone.utc).isoformat()},
        ...
        {"id": "v8", "name": "Chilkur Balaji Temple", "type": "temple", "description": "Ancient Visa Balaji temple on Osman Sagar outskirts", "avatar": "https://images.unsplash.com/photo-1609952048342-5029c2100111?w=400", "location": "Moinabad, Hyderabad", "rating": 4.8, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
        ...
        {"id": "v10", "name": "Keesaragutta Temple", "type": "temple", "description": "Ancient hilltop Shiva temple with panoramic views", "avatar": "https://images.unsplash.com/photo-1580799411471-1210de10db93?w=400", "location": "Keesara, Hyderabad", "rating": 4.6, "menuItems": [], "createdAt": datetime.now(timezone.utc).isoformat()},
