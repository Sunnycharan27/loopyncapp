...
async def seed_data():
    ...
    venues = [
        ...
        {"id": "v13", "name": "Bottles & Chimney", "type": "pub", "description": "Rooftop bar with city views and cocktails", "avatar": "https://images.unsplash.com/photo-1514933651103-005eec06c04b?w=400", "location": "Jubilee Hills, Hyderabad", "rating": 4.5, "menuItems": [{"id": "m22", "name": "Signature Cocktail", "price": 450}, {"id": "m23", "name": "Grilled Chicken", "price": 480}], "createdAt": datetime.now(timezone.utc).isoformat()},
        {"id": "v14", "name": "Over The Moon", "type": "pub", "description": "Terrace lounge with DJ nights and global cuisine", "avatar": "https://images.unsplash.com/photo-1572116469696-31de0f17cc34?w=400", "location": "Gachibowli, Hyderabad", "rating": 4.7, "menuItems": [{"id": "m24", "name": "LIIT", "price": 420}, {"id": "m25", "name": "Nachos Platter", "price": 380}], "createdAt": datetime.now(timezone.utc).isoformat()},
